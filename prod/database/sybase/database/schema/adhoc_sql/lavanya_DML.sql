...
Begin
     ...
     Select  @i_PersIDNum = 0
      ...
      -- Select @i_PersIDNum
        ...
        VALUES ( @i_PersIDNum, GetDate(), '12-31-2099 16:10:2.507', 'Lavanya',
        'Milton', 'Lavanya Milton', User, GetDate(), User, GetDate() )
        ...
        Values
        (@i_PersIDNum,1587,0,'MiltonL',GetDate())
        ...
        Values
        (@i_BusContact,'82663',@i_PersIDNum,GetDate(), '12-31-2099 16:10:2.507',User, GetDate(), User, GetDate())
         ...
         (ClientBusContactID,ClntID,PersIDNum,EffDate,ExpDate,UserCrtd,DateCrtd,UserMdfd,TempFlag)
         Values
         (@i_BusContact,'13579',@i_PersIDNum,GetDate(), '12-31-2099 16:10:2.507',User, GetDate(), User, GetDate())
         ...
         (ClientBusContactID,ClntID,PersIDNum,EffDate,ExpDate,UserCrtd,DateCrtd,UserMdfd,TempFlag)
         Values
         (@i_BusContact,'80465',@i_PersIDNum,GetDate(), '12-31-2099 16:10:2.507',User, GetDate(), User, GetDate())        
