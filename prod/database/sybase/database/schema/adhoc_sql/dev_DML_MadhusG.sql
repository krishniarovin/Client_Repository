...
Begin
     ...
     Select  @i_PersIDNum = 0
      ...
      -- Select @i_PersIDNum
        ...
        VALUES ( @i_PersIDNum, GetDate(), '12-31-2099 16:10:2.507', 'Madhusudan',
        'Gottumukkala', 'Madhusudan Gottumukkala', User, GetDate(), User, GetDate() )
        ...
        Values
        (@i_PersIDNum,1587,0,'MadhusG',GetDate())
