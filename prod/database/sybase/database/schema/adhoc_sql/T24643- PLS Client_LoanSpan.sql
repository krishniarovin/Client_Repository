/*****************************T24643- PLS Client - LoanSpan*****************************/

alter table ClientUpdates
...
IF OBJECT_ID('ClientUpdates') IS NOT NULL
EXEC sp_bindrule 'dbo.R_YES_NO_NULL','ClientUpdates.Question23_ind'
go
